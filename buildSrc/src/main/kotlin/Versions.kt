...
object Versions {
    ...
    const val omhAuthCore = "2.0.0"
    const val omhGoogleGms = "2.0.0"
    const val omhGoogleNonGms = "2.0.0"
    const val omhFacebook = "2.0.0"
    const val omhMicrosoft = "2.0.0"
    const val omhDropbox = "2.0.0"

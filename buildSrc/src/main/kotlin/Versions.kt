...
object Versions {
    ...
    const val googleApiClient = "1.33.0"
    ...
    const val omhAuthCore = "2.0.3"
    const val omhGoogleGms = "2.0.3"
    const val omhGoogleNonGms = "2.0.3"
    const val omhFacebook = "2.0.3"
    const val omhMicrosoft = "2.0.3"
    const val omhDropbox = "2.0.3"

...
To incorporate the Google GMS and non-GMS plugin into your project, you have two options: utilize
the Android OMH Core Plugin or directly include the Android OMH Client libraries dependencies.

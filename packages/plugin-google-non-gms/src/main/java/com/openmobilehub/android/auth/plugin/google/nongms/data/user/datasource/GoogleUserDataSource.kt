...
package com.openmobilehub.android.auth.plugin.google.nongms.data.user.datasource
...
internal class GoogleUserDataSource(private val sharedPreferences: SharedPreferences) :
    ...
    override suspend fun handleIdToken(idToken: String, clientId: String) {
        ...
        sharedPreferences.edit {
            ...
            putString(Constants.GOOGLE_ID_TOKEN_KEY, idToken)
        }
    }
    ...
    override fun getProfileData(): OmhUserProfile? {
        ...
        val idToken = sharedPreferences.getString(Constants.GOOGLE_ID_TOKEN_KEY, null)
